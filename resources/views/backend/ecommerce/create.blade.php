        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/ecommerce" method="post" enctype="multipart/form-data">
                        @csrf
                       ...
                       <div class="row">
                        <div class="col-md-6">
                         <div class="form-group">
                             ...
                             <input id="instagram" class="form-control" type="text" name="instagram" placeholder="enter instagram">
                         </div>
                        </div>
